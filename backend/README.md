...
## Project Structure
    ...
    ├── billowing_waterfall_42519  # Django project configurations
...
1. Clone this repo and `cd billowing_waterfall_42519`
...
2. Clone this repo and `cd billowing_waterfall_42519`
